			...
			{type === 'sidebar' ? (
				<>
					<div className='col-12 mb-1 d-flex justify-content-center'>
						<input className='srchBox ps-2' type='text' placeholder={placeholder} autoComplete='off' value={searchText} onChange={handleChange} />
					</div>
					...
					{shwDataDiv && patient && <PatientData ptId={ptId} />}
				</>
			) : (
				<>
