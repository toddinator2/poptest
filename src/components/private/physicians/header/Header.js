...
export default function Header() {
	return (
		<div className='pgPhyHdrContainer'>
			<div className='row d-flex align-items-center'>
				<div className='col-12 col-md-5 col-lg-4 col-xl-3 col-xxl-2'>
					<div className='row px-3 py-2'>
						<div className='col-12 d-flex justify-content-center'>
							<Image className='pgPhyHdrLogo' priority={true} src={logo} alt='Supernova3x' />
						</div>
					...
					<div className='row px-3 py-2'>
						<div className='col-12 d-flex justify-content-center justify-content-lg-end'>
							<a href='https://www.disneyplus.com/' target='_blank'>
								<Image className='pgPhyHdrAd' src={ad} priority={true} alt='Banner Ad' />
							</a>
						</div>
					</div>
				</div>
