		...
		<form onSubmit={handleSubmit}>
			<div className='row mb-2'>
				<div className='col-12'>
					<div className='frmLabel'>Are you currently taking any Allergy Medications?</div>
				</div>
				<div className='col-12'>
				...
				<>
					...
					<div className='row mb-2'>
						<div className='col-12 mb-1'>
							<div className='frmLabel'>Antihistamines</div>
						</div>
						<div className='col-12'>
					...
					<div className='row mb-2'>
						<div className='col-12 mb-1'>
							<div className='frmLabel'>Asthma Inhalar (Advair, Singular, Ventolin)</div>
						</div>
						<div className='col-12'>
					...
					<div className='row mb-2'>
						<div className='col-12 mb-1'>
							<div className='frmLabel'>Eye Drops</div>
						</div>
						<div className='col-12'>
					...
					<div className='row mb-2'>
						<div className='col-12 mb-1'>
							<div className='frmLabel'>Nasal Steroids</div>
						</div>
						<div className='col-12'>
					...
					<div className='row mb-2'>
						<div className='col-12 mb-1'>
							<div className='frmLabel'>Oral Steroids (Prednisone)</div>
						</div>
						<div className='col-12'>
			...
			<div className='row mb-2'>
				<div className='col-12 mb-1'>
					<div className='frmLabel'>
						Are you interested in learning more about the Testing and Treatment of Allergy and Immunological Conditions during your next visit?
						Their cost and how treatment can reduce sensitivity, get allergies under control, reduce the need for medications, and regain freedom
						from triggers while making sufferers feel better and improving quality of life with a 90% success rate.
					</div>
				</div>
				<div className='col-12'>
