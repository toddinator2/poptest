		...
		<form onSubmit={handleSubmit}>
			<div className='row mb-2'>
				<div className='col-12 mb-1'>
					<div className='frmLabel'>Are you satisfied with your level of sexual desire or interest?</div>
				</div>
			...
			<div className='row mb-2'>
				<div className='col-12 mb-1'>
					<div className='frmLabel'>Are you satisfied with your level of lubrication during sexual activity or intercourse?</div>
				</div>
				<div className='col-12'>
			...
			<div className='row mb-2'>
				<div className='col-12 mb-1'>
					<div className='frmLabel'>Are you satisfied with your overall sexual life?</div>
				</div>
				<div className='col-12'>
			...
			<div className='row mb-2'>
				<div className='col-12 mb-1'>
					<div className='frmLabel'>Do you experience discomfort or pain during sexual activity or intercourse?</div>
				</div>
				<div className='col-12'>
