			...
			<div className='row mt-5 d-flex justify-content-center'>
				<div className='suDiv red'>
					...
					<form onSubmit={handleSubmit}>
						...
						<div className='row d-flex align-items-center'>
							<div className='col-10 col-xl-5 offset-1 offset-xl-0 d-flex justify-content-start justify-content-xl-end'>
								<div className='frmLabel mb-2'>Office Phone:</div>
							</div>
							<div className='col-10 col-xl-6 col-xxl-5 offset-1 offset-xl-0 ps-0 ps-xl-2'>
						...
						<div className='row d-flex align-items-center'>
							<div className='col-10 col-xl-5 offset-1 offset-xl-0 d-flex justify-content-start justify-content-xl-end'>
								<div className='frmLabel mb-2'>Email:</div>
							</div>
							<div className='col-10 col-xl-6 col-xxl-5 offset-1 offset-xl-0 ps-0 ps-xl-2'>
				...
				<div className='suDiv blu mx-4'>
					...
					<div className='row mt-3 mb-4'>
						<div className='col-12'>
							<div className='suHdng'>Doctor Form</div>
						</div>
					</div>
					<div className='px-2 px-xl-4'>
						...
						<p>By submitting the form, you give your consent for SN3X to send information and contact your doctor on your behalf.</p>
						<p>If you don&apos;t already have a doctor or decide to choose from our growing list of SN3X Physicians, you may skip this section.</p>
					</div>
				</div>
