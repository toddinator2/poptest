...
export default function Login() {
	...
	const lsRem = process.env.REM_SPN;
	const lsData = process.env.DATA_SPN;
			...
			<div className='w-full py-7'>
				<div className='w-5/6 md:w-3/5 lg:w-4/5 2xl:w-2/3 mx-auto'>
					<div className='flex justify-center'>
						<Image className='max-h-20 lg:max-h-28 w-auto' src={icoMemberEmp} priority={true} alt='Sponsors' />
					</div>
					<div className='w-full mb-7 flex-auto'>
						<div className='w-full'>
							<div className='text-2xl lg:text-3xl 2xl:text-4xl text-center'>Sponsor Login</div>
						</div>
					</div>
					...
					<div className='w-full mt-5 flex justify-center'>
						<Link className='fgtLinkText' href='/sponsors/login/forgotusername'>
							Forgot Username
						</Link>
					</div>
					<div className='w-full mt-3 mb-3 flex justify-center'>
						<Link className='fgtLinkText' href='/sponsors/login/forgotpassword'>
							Forgot Password
						</Link>
					</div>
					{loading && <Spinner />}
