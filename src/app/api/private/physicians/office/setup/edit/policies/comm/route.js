...
export const PUT = async (req) => {
	...
	try {
		await Ofcpolicy.findOneAndUpdate({ officeuserObjId: userid, officeObjId: ofcid }, { comm: accepted, commdate: today, comminits: inits }, { new: true });
		await Ofcsetup.findOneAndUpdate({ officeObjId: ofcid }, { comm: accepted }, { new: true });
